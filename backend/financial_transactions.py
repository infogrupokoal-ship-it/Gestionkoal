...
def list_transactions():
    ...
    return render_template(
        "financial_transactions/list.html", transactions=transactions
    )
...
def add_transaction():
    ...
    if request.method == "POST":
        ...
        participantes = request.form.get(
            "participantes"
        )  # Assuming a simple text field for now
    ...
    return render_template(
        "financial_transactions/form.html", transaction=None, users=users
    )

...
from backend.whatsapp import WhatsAppClient  # For sending signed PDF via WhatsApp
...
def send_quote_for_signature(quote_id):
    ...
    try:
        ...
        client.send_text(quote['whatsapp_number'], message)
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if quote['whatsapp_number']:
                ...
                client.send_text(quote['whatsapp_number'], whatsapp_message)
